...
class PaymentDetailSerializer(serializers.ModelSerializer):
    ...
    # def get_transactions(self, obj):
    #     # Retrieve all transactions related to the payment object's student
    #     transactions_queryset = obj.student.payments.all()
        
    #     # Serialize the transactions queryset
    #     serializer = TransactionSerializer(transactions_queryset)
...
#     class Meta:
#         model = Payment
#         fields = ['id', 'student', 'bus_service', 'amount', 'method', 'paid_amount', 'balance_amount', 'transactions']
